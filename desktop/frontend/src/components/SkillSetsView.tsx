...
type ToolChoice = '' | 'claude' | 'codex' | 'muse' | 'both'
...
function toolsForChoice(choice: ToolChoice) { return choice === 'both' ? ['claude', 'codex', 'muse'] : choice ? [choice] : [] }
