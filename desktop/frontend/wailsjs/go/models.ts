...
export namespace gui {
	...
	export class DiscoverToolState {
	    tool: string;
	    status: string;
	    message?: string;

	    static createFrom(source: any = {}) {
	        return new DiscoverToolState(source);
	    }
	...
	export class DiscoverSkill {
	    ...
	    url: string;
	    installable: boolean;
	    claude: DiscoverToolState;
	    codex: DiscoverToolState;

	    static createFrom(source: any = {}) {
	        return new DiscoverSkill(source);
	    }
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.weeklyInstalls = source["weeklyInstalls"];
	        this.installsYesterday = source["installsYesterday"];
	        this.change = source["change"];
	        this.sourceType = source["sourceType"];
	        this.url = source["url"];
	        this.installable = source["installable"];
	        this.claude = this.convertValues(source["claude"], DiscoverToolState);
	        this.codex = this.convertValues(source["codex"], DiscoverToolState);
	    }
	...
	export class DiscoverDetail {
	    ...
	    static createFrom(source: any = {}) {
	        return new DiscoverDetail(source);
	    }

	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.skill = this.convertValues(source["skill"], DiscoverSkill);
	        this.description = source["description"];
	...
	export class DiscoverPage {
	    ...
	    static createFrom(source: any = {}) {
	        return new DiscoverPage(source);
	    }
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.skills = this.convertValues(source["skills"], DiscoverSkill);
	        this.fetchedAt = this.convertValues(source["fetchedAt"], null);
	        this.offline = source["offline"];
	        this.fromCache = source["fromCache"];
