...
Describe effects on filesystem ownership, reversible restore, blockers,
provider subprocesses, network access, local data, and third-party sources.

## Verification

- [ ] Root Go tests and vet pass.
...
List intentional follow-ups or `None`.
