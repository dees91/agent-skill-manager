...
7. Select the smallest useful set across both categories, never more than five skills total. Prefer no selection over a weak match. Never select a whole group or skills for more than one host.
