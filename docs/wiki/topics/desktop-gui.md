...
- All four tool columns (Claude, Codex, Muse, Grok) remain visible. The tool chip scopes
...
- The workspace lists each recipe once with optional `When to use` copy,
  member count, unavailable count, and applied/effective Claude, Codex, Muse, and Grok
