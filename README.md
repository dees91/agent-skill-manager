...
The current source version is `0.8.0`. This is a **public preview**.

### 1. Download and verify

Save both files from the [v0.8.0 release](https://github.com/dees91/agent-skill-manager/releases/tag/v0.8.0)
to your Downloads folder:

- [Download the macOS app](https://github.com/dees91/agent-skill-manager/releases/download/v0.8.0/skill-manager-desktop-0.8.0-macos-arm64.zip)
  (`skill-manager-desktop-0.8.0-macos-arm64.zip`).
- [Download SHA256SUMS.txt](https://github.com/dees91/agent-skill-manager/releases/download/v0.8.0/SHA256SUMS.txt)
...
```bash
cd "$HOME/Downloads"
grep 'skill-manager-desktop-0.8.0-macos-arm64.zip$' SHA256SUMS.txt \
  | shasum -a 256 -c -
```
