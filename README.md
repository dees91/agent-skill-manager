...
<p align="center">
  <a href="https://github.com/dees91/agent-skill-manager/releases/tag/v0.7.0">Download macOS app</a>
  ·
...
The [`v0.7.0` prerelease](https://github.com/dees91/agent-skill-manager/releases/tag/v0.7.0)
contains two Apple Silicon downloads:

- `skill-manager-desktop-0.7.0-macos-arm64.zip` contains `Skill Manager.app`;
- `skill-manager-cli-0.7.0-macos-arm64.tar.gz` contains the terminal binary,
...
```bash
shasum -a 256 skill-manager-desktop-0.7.0-macos-arm64.zip
